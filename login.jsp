...
<div class="login-box">
  <div class="login-logo">
    <a href="login"><b>OFBFFF</b> System</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="####" method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="Firefighter-Code or Admin">
    ...
    <div class="social-auth-links text-center">
        <img src="resources/AdminLTE/dist/img/login_img.jpg" style="width:300px; height:150px;">
    </div>
    <br>
   &nbsp;&nbsp;<b>O</b>f the firefighter <b>B</b>y the firefighter <b>F</b>or the firefighter<br>
   <span class="col-md-8"></span>&nbsp;&nbsp;<strong>Team. </strong> Liincoln<br>
